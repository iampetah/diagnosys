  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collaps show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="patient-request.php" class="active">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="container">
                ...
                <form action="add-pat-req.php" method="POST">
                  <div class="form first">
                    ...
                    <label>Date</label>
                      ...
                      <div class="fields">
                        ...
                        <div class="input-field">
                          ...
                          <input type="number" name="request_phone" pattern="[0-9]{11}" placeholder="Enter mobile number" required>
                        </div>
                    ...
                    <!-- <div class="packages" style="font-size: 20px;">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Store selected tests in session
    $_SESSION['selected_tests'] = $_POST['request_test'];
}
?>
                                      </div>
                                    </div>
