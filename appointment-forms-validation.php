...
</svg> &nbsp;</i><span>Transaction Logs</span>
        </a>
      </li><!-- End Charts Nav -->
                  ...
                  <?php
                            ...
                            if ($result) {
                              while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $appointment_lastname = $row['appointment_lastname'];
                                $appointment_firstname = $row['appointment_firstname'];
                                $appointment_age = $row['appointment_age'];
                                $appointment_test = $row['appointment_test'];
                                $appointment_status = $row['appointment_status'];

                                echo '<tr>   
          <td>' . $appointment_ID . '</td>
          <td>' . $appointment_lastname . '</td>
          <td>' . $appointment_firstname . '</td>
          <td>' . $appointment_age. '</td>
          <td>' . $appointment_test . '</td>
          <td>' . $appointment_status . '</td>
          <td>

          <a href="patient_reqstats.php? 
          updateid=' . $appointment_ID . '" style="color: #ffff; text-decoration:none;" ><button type="button" name="submit" class="btn btn-primary"><i class="bi bi-eye-fill"></i></button></a>
