...
$pdf->Cell(20, 10, 'Invoice#: ', 0,);
$pdf->Cell(-100, 10, "(Invoice Number)", 0);
$pdf->Ln(8);
...
$pdf->Cell(100, 2, '[Cashier Name]', 0, 0);
$pdf->SetFont('Arial', 'U', 9);
$pdf->Cell(10, 2, $request->patient->getFullName(), 0, 1);
$pdf->SetFont('Arial', '', 9);
//$pdf->Cell(60, 6, 'Cashier', 0, 0, 'C');
...
$pdf->SetFont('Arial', 'U', 9);
$pdf->Cell(310, 4, $request->patient->city, 0, 1);
