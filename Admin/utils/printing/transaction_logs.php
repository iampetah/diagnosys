...
foreach ($requests as $request) {
  ...
  //$pdf->SetY($y - 16);
  $pdf->MultiCell(25, $row_height, $request->total, 1, 0, 'C');
  $x = $pdf->GetX();
  $pdf->SetXY($x + 80, $y - $row_height);
  $pdf->MultiCell(75, $row_height, $started_date, 1, 0, 'C');
...
$pdf->Cell(129, -2, 'PCDC OWNER', 0, 0);

$pdf->Cell(150, -2, 'Information Desk', 0, 0);
