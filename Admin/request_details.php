          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <label for="inputEmail5" class="form-label">Subdivision/Street Name</label>
                  <input type="email" class="form-control" id="inputEmail5" value="<?php echo $request->patient->subdivision ?>" readonly>
                </div>
                <div class="col-md-6">
                  <label for="inputPassword5" class="form-label">Building/ House Number</label>
                  <input type="text" class="form-control" id="inputPassword5" value="<?php echo $request->patient->house_no ?>" readonly>
                </div>
                <div class="col-12">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="inputPassword5" value="" readonly>
                </div>
                <div class="col-12">
