  ...
  <path fill-rule="evenodd" d="m20.54 5.23-1.39-1.68C18.88 3.21 18.47 3 18 3H6c-.47 0-.88.21-1.16.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6.5c0-.48-.17-.93-.46-1.27ZM12 17.5 6.5 12H10v-2h4v2h3.5L12 17.5ZM5.93 4l-.81 1h13.75l-.94-1h-12Z" clip-rule="evenodd"></path>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="registered.php">
          <i class="bi bi-card-list active"></i>
          <span>Register</span>
        </a>
                          ...
                          <tr>
                            ...
                            if ($result) {
                              while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>   
                                <td>' . $register_ID . '</td>
          <td>' . $register_lastname,',','&nbsp', $register_firstname  . '</td>
          <td>' . $user_type . '</td>
         

          <td>
          <a href="#? 
          updateid=' . $register_ID . '" style="color: #ffff; text-decoration:none;" ><button type="button" name="submit" class="btn btn-primary"><i class="bi bi-eye-fill"></i> </button>
          </a>
          <a href="#? 
          updateid=' . $register_ID . '" style="color: #ffff; text-decoration:none;" ><button type="button" name="submit" class="btn btn-danger"><i class="bi bi-trash"></i></button>
          </a>
